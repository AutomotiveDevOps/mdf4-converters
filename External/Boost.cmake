...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
  ...
  set(Boost_COMPILER
      "-${BOOST_TOOLCHAIN}"
      CACHE INTERNAL "Boost compiler")
  set(Boost_ARCHITECTURE
      "-x64"
      CACHE INTERNAL "Boost arch")
...
set(Boost_COMPONENTS_TO_FIND date_time filesystem log program_options thread)
...
if(NOT Boost_FOUND)
  ...
  set(BUILD_COMMAND_ARGS
      cxxflags=${BOOST_CXXFLAGS} cflags=${BOOST_CFLAGS} --with-date_time
      --with-filesystem --with-headers --with-log --with-program_options
      --with-thread --prefix=<INSTALL_DIR> toolset=${BOOST_TOOLCHAIN}
      variant=release address-model=64 threading=multi link=static
      runtime-link=static install -j1)

  # Configure arguments to b2 when building.
  if(WIN32)
    set(BOOST_BUILD_COMMAND b2.exe ${BUILD_COMMAND_ARGS})
  else()
    set(BOOST_BUILD_COMMAND ./b2 ${BUILD_COMMAND_ARGS})
  endif()
