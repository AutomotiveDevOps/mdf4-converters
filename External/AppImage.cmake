...
set(AppImage_ROOT
    ...
    CACHE PATH "AppImage root path")
set(ENV{AppImage_ROOT} ${AppImage_ROOT})
find_package(AppImage)

if(NOT AppImage_FOUND)
  message(
    "External dependencies: AppImage not found, creating external target.")
  ...
  set(EXTERNAL_PROJECT_INSTALL_COMMAND
      COMMAND ${CMAKE_COMMAND} -E make_directory <INSTALL_DIR>/opt COMMAND
      ${CMAKE_COMMAND} -E copy_directory <SOURCE_DIR>/squashfs-root
      <INSTALL_DIR>/opt COMMAND ${CMAKE_COMMAND} -E copy
      <DOWNLOAD_DIR>/linuxdeploy-x86_64.AppImage
      <INSTALL_DIR>/opt/linuxdeploy-x86_64.AppImage COMMAND chmod +x
      <INSTALL_DIR>/opt/linuxdeploy-x86_64.AppImage)
  ...
  message(
    "External dependencies: AppImage packer (linuxdeploy) found at ${AppImage_INCLUDE_DIRS}"
  )
endif()
