...
CachingStreamBuffer::CachingStreamBuffer(std::shared_ptr<std::streambuf> parent,
...
CachingStreamBuffer::pos_type
CachingStreamBuffer::seekoff(off_type offset,
...
CachingStreamBuffer::pos_type
CachingStreamBuffer::seekpos(pos_type pos, std::ios_base::openmode mode) {
  return seekoff(pos, std::ios_base::beg, mode);
}

CachingStreamBuffer::pos_type
CachingStreamBuffer::seekBeginning(off_type offset) {
...
CachingStreamBuffer::pos_type
CachingStreamBuffer::seekCurrent(off_type offset) {
  if (offset == 0) {
