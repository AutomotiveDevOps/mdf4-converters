...
uint64_t HDBlock::getStartTimeNs() const { return startTimeNs; }

int16_t HDBlock::getTzOffsetMin() const { return tzOffsetMin; }

int16_t HDBlock::getDstOffsetMin() const { return dstOffsetMin; }
