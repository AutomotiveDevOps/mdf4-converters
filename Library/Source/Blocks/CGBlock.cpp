...
uint64_t CGBlock::getRecordID() const { return recordID; }

int64_t CGBlock::getRecordSize() const { return recordSize; }

bool CGBlock::isVLSD() const { return flags & 0x0001u; }
...
uint64_t CGBlock::getCycleCount() const { return cycleCount; }
