...
template <typename RecordType> RecordIterator<RecordType>::RecordIterator() {
  //
}

template <typename RecordType>
RecordIterator<RecordType>::RecordIterator(
...
template <typename RecordType>
RecordIterator<RecordType>::RecordIterator(
    RecordIterator<RecordType> const &other) {
...
template <typename RecordType> void RecordIterator<RecordType>::increment() {
  iterator->increment();
}

template <typename RecordType>
bool RecordIterator<RecordType>::equal(
    const mdf::RecordIterator<RecordType> &other) const {
...
template struct RecordIterator<CANRecord const>;

template struct RecordIterator<LINRecord const>;
