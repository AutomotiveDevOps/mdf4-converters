...
namespace mdf::python {
    ...
    CallbackBuffer::CallbackBuffer(Py::Object obj, std::size_t cacheSize) :
        ...
        do {
            ...
            auto const readSpec = module.callMemberFunction("getfullargspec", Py::TupleN(readMethod));
            auto const seekSpec = module.callMemberFunction("getfullargspec", Py::TupleN(seekMethod));
