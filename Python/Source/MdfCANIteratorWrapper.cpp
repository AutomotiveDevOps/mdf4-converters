...
MdfCANIteratorWrapper::MdfCANIteratorWrapper(
    mdf::RecordIterator<mdf::CANRecord const> parent)
    : it(parent) {
  //
}
...
int MdfCANIteratorWrapper::setattro(const Py::String &name_,
                                    const Py::Object &value) {
  return genericSetAttro(name_, value);
}

Py::Object MdfCANIteratorWrapper::iter() { return Py::Object(this, false); }
