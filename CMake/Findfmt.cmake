...
if(NOT ${fmt_INCLUDE_DIR} STREQUAL "fmt_INCLUDE_DIR-NOTFOUND")
  # Select the parent dir, such that all includes are in the form of
  # "fmt/header"
  ...
  function(_fmt_EXTRACT _fmt_VER_MAJOR_OUTPUT _fmt_VER_MINOR_OUTPUT
           _fmt_VER_PATCH_OUTPUT)
    set(CMAKE_MATCH_1 "0")
    set(CMAKE_MATCH_2 "0")
    set(CMAKE_MATCH_3 "0")
    set(_fmt_expr
        "^[ \\t]*#define[ \\t]+FMT_VERSION[ \\t]+([0-9])([0-9][0-9])([0-9][0-9])"
    )
    ...
    set(${_fmt_VER_MAJOR_OUTPUT}
        "${_match_1}"
        PARENT_SCOPE)
    set(${_fmt_VER_MINOR_OUTPUT}
        "${_match_2}"
        PARENT_SCOPE)
    set(${_fmt_VER_PATCH_OUTPUT}
        "${_match_3}"
        PARENT_SCOPE)
  endfunction()
  ...
  if(NOT ${CMAKE_C_PLATFORM_ID} STREQUAL "Windows")
    find_library(
      fmt_LIBRARY
      NAMES fmt fmtd
      HINTS ${_fmt_ROOT}/lib ${_fmt_ROOT}/lib/x86_64-linux-gnu)
  else()
    find_library(
      fmt_LIBRARY
      NAMES fmt fmtd
      HINTS ${_fmt_ROOT}/lib ${_fmt_ROOT}/lib64)
  endif()
  ...
  if(fmt_FOUND)
    ...
    if(NOT TARGET fmt::fmt)
      ...
      set_target_properties(
        fmt::fmt PROPERTIES IMPORTED_LOCATION "${fmt_LIBRARY}"
