...
if(NOT ${Heatshrink_INCLUDE_DIR} STREQUAL "Heatshrink_INCLUDE_DIR-NOTFOUND")
  ...
  function(_Heatshrink_EXTRACT _Heatshrink_VER_COMPONENT _Heatshrink_VER_OUTPUT)
    set(CMAKE_MATCH_1 "0")
    set(_Heatshrink_expr
        "^[ \\t]*#define[ \\t]+${_Heatshrink_VER_COMPONENT}[ \\t]+([0-9]+)$")
    file(STRINGS "${_Heatshrink_H}" _Heatshrink_ver REGEX "${_Heatshrink_expr}")
    string(REGEX MATCH "${_Heatshrink_expr}" Heatshrink_ver
                 "${_Heatshrink_ver}")
    set(${_Heatshrink_VER_OUTPUT}
        "${CMAKE_MATCH_1}"
        PARENT_SCOPE)
  endfunction()
  ...
  if(NOT ${CMAKE_C_PLATFORM_ID} STREQUAL "Windows")
    find_library(
      Heatshrink_LIBRARY
      NAMES heatshrink
      HINTS ${_Heatshrink_ROOT}/lib ${_Heatshrink_ROOT}/lib/x86_64-linux-gnu)
  else()
    find_library(
      Heatshrink_LIBRARY
      NAMES heatshrink
      HINTS ${_Heatshrink_ROOT}/lib)
  endif()

  include(FindPackageHandleStandardArgs)
  find_package_handle_standard_args(
    Heatshrink
    FOUND_VAR Heatshrink_FOUND
    REQUIRED_VARS Heatshrink_INCLUDE_DIR Heatshrink_LIBRARY
    VERSION_VAR Heatshrink_VERSION)
  ...
  if(Heatshrink_FOUND)
    ...
    if(NOT TARGET Heatshrink::Heatshrink)
      ...
      set_target_properties(
        ...
        PROPERTIES IMPORTED_LOCATION "${Heatshrink_LIBRARY}"
