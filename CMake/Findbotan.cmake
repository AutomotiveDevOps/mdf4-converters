...
if(NOT ${botan_INCLUDE_DIR} STREQUAL "botan_INCLUDE_DIR-NOTFOUND")
  ...
  function(_botan_EXTRACT _botan_VER_COMPONENT _botan_VER_OUTPUT)
    set(CMAKE_MATCH_1 "0")
    set(_botan_expr
        "^[ \\t]*#define[ \\t]+${_botan_VER_COMPONENT}[ \\t]+([0-9]+)$")
  ...
  if(NOT ${CMAKE_C_PLATFORM_ID} STREQUAL "Windows")
    find_library(
      botan_LIBRARY
      NAMES botan-2
      HINTS ${_botan_ROOT}/lib ${_botan_ROOT}/lib/x86_64-linux-gnu)
  else()
    find_library(
      botan_LIBRARY
      NAMES botan
      HINTS ${_botan_ROOT}/lib)
  endif()
endif()
...
find_package_handle_standard_args(
  ...
  REQUIRED_VARS botan_INCLUDE_DIR botan_LIBRARY
...
if(botan_FOUND)
  ...
  if(NOT TARGET botan::botan)
    ...
    set_target_properties(
      botan::botan
      PROPERTIES IMPORTED_LOCATION "${botan_LIBRARY}"
