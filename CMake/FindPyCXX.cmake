...
find_package_handle_standard_args(
  PyCXX
  FOUND_VAR PyCXX_FOUND
  REQUIRED_VARS PyCXX_INCLUDE_DIR
  VERSION_VAR PyCXX_VERSION)
...
if(PyCXX_FOUND)
  ...
  if(NOT TARGET PyCXX::PyCXX)
    ...
    set_target_properties(
      PyCXX::PyCXX
      PROPERTIES INTERFACE_COMPILE_DEFINITIONS Py_LIMITED_API=0x03040000
                 INTERFACE_INCLUDE_DIRECTORIES "${PyCXX_INCLUDE_DIRS}")

    target_sources(PyCXX::PyCXX INTERFACE ${PyCXX_SOURCES})
  else()
