...
bool PEAK_Exporter::convert(boost::filesystem::path inputFilePath,
...
Version PEAK_Exporter::getVersion() const { return mdf::tools::peak::version; }

void PEAK_Exporter::configureParser(
    boost::program_options::options_description &opts) {
  // Add option for selecting which version to target.
  opts.add_options()(
      "trace-format,f",
      boost::program_options::value<PEAK_TraceFormat>(&traceFormat)
          ->default_value(PEAK_TraceFormat::VERSION_2_1),
