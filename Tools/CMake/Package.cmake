function(pack_executable target)
  # Setup a dependency on all additional files, such that the target is rebuilt
  # if any changes.
...
function(copy_additional_files target)
  ...
  foreach(ADDITIONAL_FILE ${ADDITIONAL_FILES})
    configure_file(
      ...
      ${CMAKE_BINARY_DIR}/Release/${target}_${ADDITIONAL_FILE} COPYONLY)
  endforeach()
endfunction()

function(pack_executable_mingw target)
  # Insert the relevant data into the Windows resource file definition and place
  # it in the binary directory.
  configure_file(${RESOURCE_PATH}/Windows.rc.in
  ...
  # Custom installer target to copy over the executable into the release
  # directory.
  add_custom_command(
    TARGET ${target}
    POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E make_directory ${CMAKE_BINARY_DIR}/Release
    COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE_NAME:${target}>
            ${CMAKE_BINARY_DIR}/Release/$<TARGET_FILE_NAME:${target}>)
endfunction()
