...
template <typename T> class GenericRecordExporter {
public:
...
template <typename T>
GenericRecordExporter<T>::GenericRecordExporter(std::ostream &output)
    : output(output) {}

template <typename T> void GenericRecordExporter<T>::writeFooter() {
  // Do nothing in default implementation.
}

template <typename T> void GenericRecordExporter<T>::writeHeader() {
  // Do nothing in default implementation.
}
