...
ConverterInterface::ConverterInterface(std::string programName,
                                       bool usesConfigurationFile)
...
void ConverterInterface::configureParser(
    boost::program_options::options_description &opts) {
  // Default implementation does nothing.
}

void ConverterInterface::configureFileParser(
    boost::program_options::options_description &opts) {
  // Default implementation does nothing.
}

ParseOptionStatus ConverterInterface::parseOptions(
    boost::program_options::variables_map const &result) {
  return ParseOptionStatus::NoError;
}

int ConverterInterface::setCommonOptions(
