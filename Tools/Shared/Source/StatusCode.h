...
/*!Possible statuscodes. Since the value returned on POSIX from a process is
 * limited to an unsigned 8 bit variable, the scope is limited. If the MSB is
 * set, it denotes a single error code by parsing the remaining 7 bits as an
