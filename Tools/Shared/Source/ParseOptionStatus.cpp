...
ParseOptionStatus operator&(ParseOptionStatus const &lhs,
                            ParseOptionStatus const &rhs) {
  ...
  return static_cast<ParseOptionStatus>(static_cast<T>(lhs) &
                                        static_cast<T>(rhs));
}
...
ParseOptionStatus &operator|=(ParseOptionStatus &lhs,
                              ParseOptionStatus const &rhs) {
  lhs = lhs | rhs;
  return lhs;
}
