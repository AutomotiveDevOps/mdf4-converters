...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclass
class FileAdditionalSpecification:
    input_name: str
    name: str
    relative_path: str = "."
...
def load_params_from_json_files(
    files: Union[str, Path, List[str], List[Path]]
) -> List[DataForTestCase]:
