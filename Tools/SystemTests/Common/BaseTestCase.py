...
import pytest
from Common.DataAccess import get_shared_data
from Common.DataAccess import get_shared_file
...
class BaseTestCase:
    ...
    def copy_binary_files(
        self, data: DataForTestCase, temporary_folder: Path, get_release_binaries
    ):
        # Save parameters.
        self._data = data
    ...
    def _copy_additional_files(self):
        ...
        for additional_file in self._data.additional_files:
            ...
            if additional_file.relative_to_data:
                dst = (
                    self._data_folder
                    / Path(additional_file.relative_path)
